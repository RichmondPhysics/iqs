...
\item Safety glasses.
\end{itemize}
\textbf{Activity \stepcounter{activity}\arabic{activity}: Observing an Airplane Undergoing Circular Motion} 
...
\textbf{Activity \stepcounter{activity}\arabic{activity}: Analyzing Circular Motion }
...
do this task follow the instructions in \textbf{Appendix
...
Use the graphing capabilities of the video software or
...
\vspace{0.3cm}
{\par\centering \includegraphics{iqsUniformCircularMotion/circ_motion_fig1.eps} \par}
\vspace{0.3cm}
...
\vspace{0.3cm}
{\par\centering \includegraphics{iqsUniformCircularMotion/circ_motion_fig2.eps} \par}
\vspace{0.3cm}
...
\vspace{0.3cm}
{\par\raggedright \includegraphics{iqsUniformCircularMotion/circ_motion_fig3.eps} \par}
\vspace{0.3cm}
