...
\vspace{0.3cm}
{\par\raggedright \includegraphics[height=2.0cm]{rotation/circle1.eps} \par}
\vspace{0.3cm}
...
\vspace{0.3cm}
{\par\centering \includegraphics[height=4.0cm]{rotation/lightRods.eps} \par}
\vspace{0.3cm}
...
\vspace{0.3cm}
{\par\centering \includegraphics[height=3.0cm]{rotation/rotator.eps} \par}
\vspace{0.3cm}
...
\end{enumerate}
\vspace{0.3cm}
{\par\centering \includegraphics{rotation/radians.eps}\put(-200,40){\parbox{1.0in}{\Large $\theta =1~rad$ when $s=r$.}} \par}
\vspace{0.3cm}
...
\vspace{0.3cm}
{\par\raggedright \includegraphics[height=4.5cm]{rotation/angularVelocity.eps} \par}
\vspace{0.2cm}
